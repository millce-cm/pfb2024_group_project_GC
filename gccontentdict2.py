...
with open("full_cds_cleaned.fa.tim", 'r') as file:
    for line in file:
        line = line.strip()  # Remove leading/trailing whitespace
        if line.startswith('>'):
            if line.startswith('>K') or line.startswith('>G') or line.startswith('>MT'):  # If there's a header line
                header = 'bad'
            else:
...
with open('fasta_dict_cds.p', 'wb') as fp:
